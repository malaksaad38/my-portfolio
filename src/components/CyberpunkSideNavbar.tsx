    ...
    return (
        <aside className="fixed top-6 left-6 h-[calc(100vh-48px)] w-20 md:w-24 lg:w-28 z-50">
            ...
            <div className="relative h-full w-full rounded-3xl overflow-hidden shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-br from-[#0f0620] via-[#0b0b12] to-[#00101f] opacity-95"></div>

                {/* Neon border */}


                {/* Inner glass panel */}
                <div className="relative h-full w-full rounded-3xl p-2 md:p-3 lg:p-4 bg-black/20 backdrop-blur-sm border border-white/5">
                        ...
                        {items.map((it, idx) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    <div className="absolute inset-0 rounded-xl blur-xl bg-[radial-gradient(ellipse_at_center,rgba(255,0,200,0.18),transparent 40%),radial-gradient(ellipse_at_center,rgba(0,255,210,0.12),transparent 50%)] mix-blend-screen"></div>
                                </div>

                                    <div className="transform-gpu group-hover:-translate-y-0.5 transition-transform duration-250 rotate-90">{it.label}</div>

                                {/* color indicator on left */}
                                <span className={`absolute left-0 top-0 h-full w-1 rounded-l-lg bg-gradient-to-b from-[rgba(255,0,200,0.9)] to-[rgba(0,255,210,0.9)] opacity-70 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300`}></span>
                                ...
                                >
                                    <span className="inline-block transform -rotate-6 text-neon-animated">{it.label}</span>
                                </motion.span>
                            </motion.button>
                        ))}
                    </nav>
                    ...
                    <div className="pointer-events-none absolute inset-0 mix-blend-overlay opacity-10">
                        <div className="h-full w-full bg-[repeating-linear-gradient(0deg,rgba(255,255,255,0.02),rgba(255,255,255,0.02) 1px,transparent 1px,transparent 3px)]"></div>
                    </div>
                </div>
            </div>
