                ...
                return (
                    <ScrollArea className="w-full h-full">
                        <div className="p-8">
                            ...
                            <h1 className={`text-4xl font-semibold mb-4 font-cyber-outline animate-pulse ${page.text}`}>Dragon
                                devs_</h1>
                ...
                return (
                    <ScrollArea className="w-full h-full">
                        <div className="p-8">
                            ...
                            <p className="text-lg">Learn about our company and our mission to create innovative web
                                experiences.</p>
                ...
                return (
                    <ScrollArea className="w-full h-full">
                        <div className="p-8">
                            ...
                            <h1 className={`text-4xl font-semibold mb-4 font-cyber-outline ${page.text}`}>Contact
                                Us</h1>
